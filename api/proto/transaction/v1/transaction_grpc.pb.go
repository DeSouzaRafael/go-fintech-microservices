...
const (
	TransactionService_InitiateTransfer_FullMethodName = "/fintech.transaction.v1.TransactionService/InitiateTransfer"
	TransactionService_GetTransaction_FullMethodName   = "/fintech.transaction.v1.TransactionService/GetTransaction"
)
...
func (c *transactionServiceClient) InitiateTransfer(ctx context.Context, in *InitiateTransferRequest, opts ...grpc.CallOption) (*InitiateTransferResponse, error) {
...
func (UnimplementedTransactionServiceServer) InitiateTransfer(context.Context, *InitiateTransferRequest) (*InitiateTransferResponse, error) {
...
func _TransactionService_InitiateTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).InitiateTransfer(ctx, req.(*InitiateTransferRequest))
	}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fintech.transaction.v1.TransactionService",
